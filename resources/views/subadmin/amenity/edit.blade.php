    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('subadmin.amenity.edit', $amenity->id) }}" method="post" id="addAmenityForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea type="text" class="form-control" name="amenity_short_description" id="amenity_short_description" placeholder="Amenity Short Description" >{{ $amenity->short_description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
...
//            },
    ...
    $(document).on('click', '.delete_amenity_image', function () {
        ...
        if (record_id) {
            $.ajax({
                url: _baseUrl + '/sub-admin/amenity/delete-amenity-images',
                type: 'post',
    ...
    $(document).on('click', '.delete_time_slot', function () {
        ...
        if (record_id) {
            $.ajax({
                url: _baseUrl + '/sub-admin/amenity/delete-time-slot',
                type: 'post',
                data: {record_id: record_id},
                dataType: 'json',
                success: function (res) {
