                ...
                <form class="form-horizontal form-label-left" action="{{ route('subadmin.amenity.edit', $amenity->id) }}" method="post" id="addAmenityForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="text" class="form-control" name="amenity_short_description" id="amenity_short_description" placeholder="Amenity Short Description" value="{{ $amenity->short_description }}">
                        </div>
                    </div>
                    <div class="form-group">
