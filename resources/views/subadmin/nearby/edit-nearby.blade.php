    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('subadmin.nearby.edit', $data->id) }}" method="post" id="editNearbyForm" >
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-4">
                            <a class="btn btn-default" href="{{ route('subadmin.nearby.index') }}">Cancel</a>
