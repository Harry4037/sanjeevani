            ...
            <div class="x_content">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="{{route('subadmin.users.user-order', $user->id)}}" method="post" id="orderItem">
                            @csrf
                            <div class="row">
                            ...
                            <a href="{{route('subadmin.users.index')}}" class="btn btn-danger pull-right" >Cancel</a>
...
<script>
    $(document).ready(function () {
        $(document).on('click', "#add_meal_item", function () {
            ...
            $.ajax({
                url: _baseUrl + "/sub-admin/user/user-meal-item",
                type: "POST",
                data: {
                    user_id: "{{$user->id}}",
        ...
        $(document).on('click', "#add_meal_package", function () {
            ...
            $.ajax({
                url: _baseUrl + "/sub-admin/user/user-meal-package",
                type: "POST",
                data: {
                    user_id: "{{$user->id}}",
