    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <h2>Change Operator Password ({{ $user->user_name }})</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form class="form-horizontal form-label-left" action="{{ route('admin.operator.change-password', $user->id) }}" method="post" id="profileForm" >
                    @csrf
