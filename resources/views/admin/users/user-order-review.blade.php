            ...
            <div class="x_content">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="{{route('admin.users.user-order-create')}}" method="post" id="orderItem">
                            @csrf
                            ...
                            <a href="{{route('admin.users.user-order', $user->id)}}" class="btn btn-danger pull-right" >Cancel</a>
