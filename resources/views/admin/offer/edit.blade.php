    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-6">
                            ...
                            <button style="margin-left: 40px;" class="btn btn-danger btn-xs delete_offer_image" id="{{ $roomImage->id }}" >Remove</button>
                        </div>
                        @endforeach
                    </div>
                    @endif
                ...
                <form class="form-horizontal form-label-left" action="{{ route('admin.offer.edit', $amenity->id) }}" method="post" id="addOfferForm" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control" id="resort_id" name="resort_id">
                                ...
                                <option value="{{ $resort->id }}"
                                        @if($resort->id == $amenity->resort_id)
                                        {{ "selected" }}
                                        @endif
                                        >{{ $resort->name }}</option>
                                @endforeach
...
//For ckeditor
    ...
    $(document).on('click', '.delete_offer_image', function () {
        ...
        if (record_id) {
            $.ajax({
                url: _baseUrl + '/admin/offer/delete-offer-images',
                type: 'post',
