    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('admin.amenity.add') }}" method="post" id="addAmenityForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea class="form-control" name="amenity_short_description" id="amenity_short_description" placeholder="Amenity Short Description"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
