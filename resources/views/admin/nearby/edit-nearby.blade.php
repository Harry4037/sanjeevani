                ...
                <div class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-6">
                            <img src="{{ $nearbyImage->name }}" width=150 height=150>
                            <button style="margin-left: 30px;" class="btn btn-info btn-xs delete_nearby_image" id="{{ $nearbyImage->id }}" >Remove</button>
                        </div>
                        @endforeach
                    </div>
                    @endif
