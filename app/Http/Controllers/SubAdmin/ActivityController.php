...
//                $resortsArray[$i]['resort_name'] = $resort->name;
    ...
    public function create(Request $request) {
        ...
        try {
            if ($request->isMethod("post")) {
                ...
                if ($validator->fails()) {
                    return redirect()->route('subadmin.activity.add')->withErrors($validator)->withInput();
                }
    ...
    public function editActivity(Request $request) {
        ...
        if ($request->isMethod("post")) {
            ...
            if ($validator->fails()) {
                return redirect()->route('subadmin.activity.edit', $request->id)->withErrors($validator)->withInput();
            }
            $amenity->name = $request->amenity_name;
            $amenity->description = $request->amenity_description;
