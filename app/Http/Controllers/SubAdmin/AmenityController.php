...
class AmenityController extends Controller {
    ...
    public function index() {
        ...
        return view('subadmin.amenity.index', ['js' => $js, 'css' => $css]);
    }
...
//            dd($amenities->toArray());
            ...
            foreach ($amenities as $amenity) {
                ...
                $resortsArray[$i]['action'] = '<a href="' . route('subadmin.amenity.edit', $amenity->id) . '" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>'
    ...
    public function create(Request $request) {
        ...
        try {
            ...
            return view('subadmin.amenity.create', [
                'js' => $js,
                'css' => $css,
            ]);
        } catch (\Exception $ex) {
            return redirect()->route('subadmin.amenity.index')->with('error', $ex->getMessage());
        }
    }
...
//            $amenity->resort_id = $request->resort_id;
        ...
        return view('subadmin.amenity.edit', [
            'css' => $css,
            'js' => $js,
